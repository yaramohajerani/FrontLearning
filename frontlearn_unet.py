...
def unet_model(channels,height,width):
    ...
    #-- c1 has shape (None, w, h, 12), 12 convlution outputs for 12 filters
    c1 = kl.Conv2D(12,3,activation='relu',padding='same')(inputs)

    #-- pool, 2x2 blockcs
    #-- p1 has shape (None, w/2, h/2, 12)
    p1 = kl.MaxPooling2D(pool_size=(2,2))(c1)

    # 2nd convlution layer
    #-- c2 has shape (None, w/2, h/2, 24)
